import { c as create_ssr_component, d as add_attribute, e as escape, v as validate_component, m as missing_component } from "./ssr.js";
...
const Twitter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return ` <svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor"><g><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>`;
});
const SocialIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${url ? `<a class="flex gap-x-2 text-gray-500 transition hover:text-primary-600"${add_attribute("href", url || "#", 0)}${add_attribute("target", popup ? "_blank" : "", 0)} rel="noreferrer"><span class="sr-only">${escape(icon)}</span>  ${validate_component(svg || missing_component, "svelte:component").$$render($$result, {}, {}, {})} <span>${slots.default ? slots.default({}) : ``}</span></a>` : ``}`;
});
export {
  SocialIcon as S
};
