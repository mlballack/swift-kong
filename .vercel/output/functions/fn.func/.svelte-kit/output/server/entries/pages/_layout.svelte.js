...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer><div class="mt-16 flex flex-col items-center border-t pt-6 gap-2"><div class="mb-3 flex space-x-2">${validate_component(SocialIcon, "SocialIcon").$$render(
    ...
    {},
    {}
  )} ${validate_component(SocialIcon, "SocialIcon").$$render($$result, { icon: "github", url: config.github }, {}, {})} ${validate_component(SocialIcon, "SocialIcon").$$render($$result, { icon: "facebook", url: config.facebook }, {}, {})} ${validate_component(SocialIcon, "SocialIcon").$$render($$result, { icon: "youtube", url: config.youtube }, {}, {})} ${validate_component(SocialIcon, "SocialIcon").$$render($$result, { icon: "linkedin", url: config.linkedin }, {}, {})} ${validate_component(SocialIcon, "SocialIcon").$$render($$result, { icon: "twitter", url: config.twitter }, {}, {})}</div>  <div class="flex space-x-2 text-sm text-gray-500 dark:text-gray-400"><a href="/">${escape(config.title)}</a>   •   © ${escape(year)} ${escape(config.author)}   •   <a href="/rss.xml" data-svelte-h="svelte-6tntdo">RSS Feed</a></div> <div class="mb-4 flex space-x-2 text-sm text-gray-500 dark:text-gray-400" data-svelte-h="svelte-rrfox6"><a href="/privacy-policy">Privacy Policy</a></div></div></footer>`;
});
